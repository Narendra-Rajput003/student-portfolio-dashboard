...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://student-portfolio-backend.onrender.com/api/v1/timeline/getall",
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://student-portfolio-backend.onrender.com/api/v1/timeline/add",
      data,
      {
        withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://student-portfolio-backend.onrender.com/api/v1/timeline/delete/${id}`,
      {
        withCredentials: true,
      }
    );
