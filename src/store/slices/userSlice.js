...
export const login = (email, password) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "https://student-portfolio-backend.onrender.com/api/v1/user/login",
      { email, password },
...
export const logout = () => async (dispatch) => {
  try {
    const { data } = await axios.get(
      "https://student-portfolio-backend.onrender.com/api/v1/user/logout",
      { withCredentials: true }
    );
  ...
  (currentPassword, newPassword, confirmNewPassword) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.put(
        "https://student-portfolio-backend.onrender.com/api/v1/user/password/update",
...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      "https://student-portfolio-backend.onrender.com/api/v1/user/me/profile/update",
      data,
      {
        withCredentials: true,
